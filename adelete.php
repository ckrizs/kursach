...
<body>
  ...
  <div class="navigation-bar" style="text-align: center">
    <a href="admin_panel.php" >Домашня</a>
  ...
  <div class='input-form-box'>
    ...
    <div class='input-form-box'>
      <form class='input-form' action='adelete_d.php' method='post'>
        <label for='dssn'>ID лікаря</label>
        <input type='text' name='dssn' placeholder='Enter a valid ID лікаря' required><br>
  ...
  <div class='input-form-box'>
    <form class='input-form' action='adelete_s.php' method='post'>
      ...
      <input type='submit' name='input-submit' value='Видалити'>
    </form>
